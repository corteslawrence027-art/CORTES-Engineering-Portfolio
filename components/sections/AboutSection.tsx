      ...
      <div className="mx-auto grid max-w-6xl gap-16 md:grid-cols-[1.1fr_0.9fr] md:items-center">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-zinc-400 leading-relaxed">
            I'm Lawrence Cortes, a software developer based in Cebu, Philippines. I bridge the gap
            between technical engineering and visual brand design — from writing Next.js APIs to
            crafting brand identities in Photoshop.
          </p>
